        ...
        <div className="mt-10 flex flex-col lg:flex-row lg:space-x-8">
          <div className="lg:w-1/2">
            ...
            <form className="mt-6" onSubmit={handleSubmit}>
              ...
              <div className="mt-6">
                <button type="submit" className="inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-green-600 hover:bg-green-700">
                  Send Message
                </button>
              </div>
            </form>
