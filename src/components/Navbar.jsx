    ...
    <nav className="bg-white shadow-lg fixed top-0 w-full z-50">
        ...
        <div className="flex justify-between items-center">
          <div className="flex space-x-7">
            ...
            <div className="hidden md:flex items-center space-x-1">
              ...
              <HashLink smooth to="/#menu" className={`py-4 px-2 ${location.hash === '#menu' ? 'text-green-500 border-b-4 border-green-500 font-semibold' : 'text-gray-500 font-semibold'}`}>Menu</HashLink>
              ...
              {isLoggedIn && (
                <Link to="/landing" className={`py-4 px-2 ${location.pathname === '/landing' ? 'text-green-500 border-b-4 border-green-500 font-semibold' : 'text-gray-500 font-semibold'}`}>Landing</Link>
              )}
      ...
      <div className={`mobile-menu ${showMobileMenu ? 'block' : 'hidden'}`}>
        <ul className="">
          ...
          <li><HashLink smooth to="/#menu" className="block text-sm px-2 py-4 hover:bg-green-500 transition duration-300">Menu</HashLink></li>
